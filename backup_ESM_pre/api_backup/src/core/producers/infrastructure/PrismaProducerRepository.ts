...
import { FindProducersCriteria, IProducerRepository, ProducerList } from '../../../domain/repositories/IProducerRepository.js';
...
export class PrismaProducerRepository implements IProducerRepository {
  ...
  async find(criteria: FindProducersCriteria): Promise<ProducerList> {
    ...
    try {
      ...
      console.error("[DEBUG] Repo Error during find:", error);
      throw error;
    }
  }
