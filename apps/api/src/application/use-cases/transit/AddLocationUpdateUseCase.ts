...
import { TransitTrackingService, LocationUpdateResult } from '../../../domain/services/TransitTrackingService.js';
...
export class AddLocationUpdateUseCase {
  ...
  async execute(request: AddLocationUpdateRequest): Promise<LocationUpdateResult> {
