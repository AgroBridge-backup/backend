...
import { ExportCompany, ExportCompanyTier, CreateExportCompanyInput } from '../../../domain/entities/ExportCompany.js';
...
export class RegisterExportCompanyUseCase {
  ...
  async execute(request: RegisterExportCompanyRequest): Promise<RegisterExportCompanyResponse> {
