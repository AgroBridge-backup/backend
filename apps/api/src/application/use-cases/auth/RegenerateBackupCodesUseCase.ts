...
export class RegenerateBackupCodesUseCase
  implements IUseCase<RegenerateBackupCodesRequestDto, RegenerateBackupCodesResponseDto>
{
  constructor(private readonly userRepository: IUserRepository) {}

  async execute(dto: RegenerateBackupCodesRequestDto): Promise<RegenerateBackupCodesResponseDto> {
