...
import { OrganicField, OrganicFieldStatus } from '../../../domain/entities/OrganicField.js';
...
export class ListProducerFieldsUseCase {
  ...
  async execute(request: ListProducerFieldsRequest): Promise<ListProducerFieldsResponse> {
    ...
    const result = await this.fieldService.listProducerFields(request.producerId, {
