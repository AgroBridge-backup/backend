 ...
 */
export const VALID_CERTIFICATE_GRADES = ['STANDARD', 'PREMIUM', 'EXPORT', 'ORGANIC'] as const;

/**
 * Type guard for CertificateGrade
 */
export function isValidCertificateGrade(value: string): value is CertificateGrade {
...
export const issueCertificateSchema = z.object({
  ...
  body: z.object({
    ...
    certifyingBody: z
      ...
      .regex(/^[\p{L}\p{N}\s.,-]+$/u, 'Certifying body contains invalid characters'),
    validityDays: z
      .number()
