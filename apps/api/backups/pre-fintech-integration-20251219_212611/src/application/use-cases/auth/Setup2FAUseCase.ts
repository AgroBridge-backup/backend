...
import { Setup2FARequestDto, Setup2FAResponseDto } from '../../dtos/auth.dtos.js';
import { twoFactorService } from '../../../infrastructure/auth/TwoFactorService.js';
import { IUserRepository } from '../../../domain/repositories/IUserRepository.js';
import { NotFoundError } from '../../../shared/errors/NotFoundError.js';
import logger from '../../../shared/utils/logger.js';

export class Setup2FAUseCase implements IUseCase<Setup2FARequestDto, Setup2FAResponseDto> {
